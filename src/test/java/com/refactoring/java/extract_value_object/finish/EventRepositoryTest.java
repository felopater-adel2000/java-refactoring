...
import com.refactoring.java.extract_value_object.finish.Event;
import com.refactoring.java.extract_value_object.finish.EventRepository;
...
public class EventRepositoryTest {
    ...
    @Test
    public void should_not_remove_anything_on_null_date() {
        repository.add(EXPECTED_EVENT);

        assertThatThrownBy(() -> repository.removeOverlappingEvents(null)).isInstanceOf(IllegalArgumentException.class);

        assertThat(repository.count()).isEqualTo(1);
    }

    @Test
    public void should_not_remove_non_overlapping_events() {
        repository.add(EXPECTED_EVENT);
    ...
    @Test
    public void should_remove_overlapping_events() {
        repository.add(EXPECTED_EVENT);
    ...
    @Test
    public void should_remove_events_at_same_from_date() {
        repository.add(EXPECTED_EVENT);
    ...
    @Test
    public void should_remove_events_at_same_to_date() {
        repository.add(EXPECTED_EVENT);
